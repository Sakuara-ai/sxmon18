...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '272e9603c6cd8101b2d7ced0a028c9fe,en:272e9603c6cd8101b2d7ced0a028c9fe',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '青烟', // 您的昵称 例如 sxmon
  BIO: process.env.NEXT_PUBLIC_BIO || '天青色等烟雨, 而我在等你', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://doc.sxm18.pp.ua/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, sxmon, 苏以墨, 青烟', // 网站关键词 英文逗号隔开
